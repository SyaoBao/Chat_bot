...
Поток данных
Ввод пользователя → Telegram команда /choose

Валидация → проверка формата и значений

Загрузка данных → Yahoo Finance API

Подготовка данных → разделение на train/test

Обучение моделей → параллельное обучение трёх моделей

Выбор лучшей → сравнение по MAPE

Прогнозирование → 30 рабочих дней

Анализ прогноза → поиск минимумов/максимумов

Расчёт прибыли → симуляция торговой стратегии

Визуализация → построение графика

Отправка результатов → пользователю в Telegram
